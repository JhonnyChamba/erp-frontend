  ...
  (SweetAlert.prototype.init = function () {
    ...
    $("#sa-image").click(function () {
      Swal.fire({
        ...
        imageUrl: "./controller/images/profile/user-2.jpg",
      });
    });
    ...
    $("#sa-bg").click(function () {
      Swal.fire({
        ...
        padding: "3em",
        background:
          "var(--bs-body-bg) url(./controller/images/backgrounds/active-bg.png)",
        backdrop: `
                          rgba(0,0,123,0.4)
                          url("./controller/images/backgrounds/nyan-cat.gif")
                          center left
                          no-repeat
                      `,
      });
